...
-- Write SQL query here
SELECT * FROM countrylanguage WHERE countrylanguage.language = 'Italian' ORDER BY percentage  DESC;
SELECT * FROM countrylanguage WHERE countrylanguage.language = 'Italian' ORDER BY percentage  DESC LIMIT 1;
...
SELECT countrycode FROM city WHERE city.name = 'Serra';
